...
# engine = chess.engine.SimpleEngine.popen_uci('C:/chess/stockfish-10-win/Windows/stockfish_10_x64.exe')
...
class EasyChessGui:
    ...
    def play_game(self, window, x, board):
        ...
        if board.is_game_over(claim_draw=True):
            BOX_TITLE = "Game Over"
            sg.Popup('Game Over!', title=BOX_TITLE, icon='Icon/pecg.ico')
    ...
    def build_main_layout(self, is_user_white=True):
        ...
        board_tab = [[sg.Column(board_layout)],
                     [sg.Text('a', size=(1, 1), font=('Consolas', 10), key='_litera_')],
                    ...
                    if e == 'OK':
                        ...
                        try:
                            ...
                            if current_engine_id_name != self.opp_id_name:
                                logging.info("User selected a new opponent {}.".format(self.opp_id_name))
                        break
